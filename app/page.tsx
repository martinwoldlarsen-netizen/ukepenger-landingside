...
export default function Page() {
  ...
  return (
    <main id="top" className="min-h-screen overflow-hidden bg-background">
      ...
      {menuOpen && <div className="mx-5 flex flex-col gap-2 rounded-2xl border border-border bg-card p-3 md:hidden"><a href="#slik-fungerer-det" className="rounded-xl px-4 py-3 text-sm font-semibold" onClick={() => setMenuOpen(false)}>Slik fungerer det</a><a href="#for-familien" className="rounded-xl px-4 py-3 text-sm font-semibold" onClick={() => setMenuOpen(false)}>For familien</a><a href="#kom-i-gang" className="button-primary justify-center">Kom i gang <ArrowRight className="size-4" /></a></div>}
